        ...
        <section className="py-16 px-4 max-w-7xl mx-auto">
          <div className="bg-white rounded-3xl shadow-xl p-8 md:p-12 border border-slate-100">
            <div className="text-center mb-12">
              ...
              <p className="text-slate-500 text-lg">Comprendre ces facteurs vous aide à prendre des decisiones éclairées pour votre projet</p>
            </div>
            ...
            <div className="grid grid-cols-1 md:grid-cols-3 gap-8 mb-12 relative">
              ...
              <div className="border border-slate-200 rounded-2xl p-8 pt-12 relative text-center flex flex-col items-center">
                ...
                <p className="text-sm text-slate-600 mb-8 flex-grow">
                  Utilisez le calculateur ci-dessus pour obtenir votre estimation détaillée instantanément, o téléchargez le PDF pour le revoir calmement.
                </p>
        ...
        <section className="py-16 px-4 max-w-4xl mx-auto">
          ...
          <div className="space-y-4">
            <FAQItem 
              ...
              answer="Zéro surprise. Votre devis comprend TOUT : design personnalisé, développement complet, hébergement pour 1 an, certificat SSL de sécurité, formation pour que vous gériez votre site, et 30 jours de support post-lancement. Les seuls coûts supplémentaires seraient des fonctionnalités supplémentaires que vous demandez par la suite o le renouvellement annuel de l'hébergement (que nous vous signalons 60 jours à l'avance)."
              color="blue"
            />
